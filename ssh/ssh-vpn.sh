...
state=Indonesia
locality=Sumatera
organization=SeoFast
organizationalunit=SeoFast
commonname=none
email=admin@rocketssh.com
...
# download script
cd /usr/bin
wget -O speedtest "https://github.com/khairunisya/speedtest-cli/raw/main/speedtest_cli.py"
